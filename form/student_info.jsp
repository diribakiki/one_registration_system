<%-- 
    ...
    Created on : Apr 9, 2024, 11:58:53 AM
    Author     : hp
--%>
    ...
    <body bgcolor="#735b3d" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
		...
		<ul>
                    <h3> <a href="http://localhost:8080/Online%20school%20registration%20system/index.html">Homepage</a>&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="http://localhost:8080/Online%20school%20registration%20system/form/grade_forstudent.jsp">Grade result</a>&nbsp;&nbsp;&nbsp;&nbsp;
                         <a href="http://localhost:8080/Online%20school%20registration%20system/form/subject.jsp"> Course</a>&nbsp;&nbsp;&nbsp;&nbsp;
                         <a href="http://localhost:8080/Online%20school%20registration%20system/form/notice.jsp">notice</a><h3>
                            ...
                            <marquee behavior =alternate direction=right> <font size=3 color=blue> <b> <font size=5>W</font>elcome to the <font size=5>O</font>line<font size=5>R</font>egistration <font size=5>P</font>ortal </font></td>
                                    ...
                                    <tr>
                                        ...
                                        <td id="contents" width="540" height="522" align="left" valign="top"><br>
                                            ...
                                            <h1> student information form </h1><br/><p></p><br/>

                                            <form action="student_info_data.jsp" method="POST"class="form" onsubmit="return validAddStudentinfo();">

                                                <input type="text" name="S_id" placeholder="enter the  student id" size="50"/><br><p> </p>
                                                <input type="text" name="S_name" placeholder="enter the student name" size="50"/><br><p> </p>
                                                <input type="text" name="C_id" placeholder="enter the course id" size="50"/><br><p> </p>
                                                <input type="text" name= "Roll_id" placeholder="enter the roll id"size="50" /><br><p> </p>
                                                <input type="text" name="sess_id" placeholder="enter the session"size="50" /><br><p> </p>
                                                <input type="text" name="Gender" placeholder="enter the sex" size="50"/><br><p> </p>
                                                <input type="text" name="dob" placeholder="enter the date of birth" size="50"/><br><p> </p>
                                                ...
                                                <input type="text" name="telephone_no" placeholder="enter the telephone number" size="50"/><br><p> </p>
                                                <input type="text" name="mobile_no" placeholder="enter the mobile number" size="50"/><br><p> </p>
                                                <input type="text" name="email" placeholder="enter the email address" size="50"/><br><p> </p>
                                                <input type="text" name="Pre_address" placeholder="enter the present address" size="50"/><br><p> </p>
                                                <input type="text" name="per_address" placeholder="enter the permanent " size="50"/><br><p> </p>
