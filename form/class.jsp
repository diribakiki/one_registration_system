<%-- 
    Document   : class
    Created on : Apr 11, 2024, 5:26:41 PM
    Author     : hp
--%>
                            ...
                            <marquee behavior =alternate direction=right> <font size=3 color=blue> <b> <font size=5>W</font>elcome to the <font size=5>O</font>line<font size=5>R</font>egistration <font size=5>P</font>ortal </font></td>
                                    ...
                                    <tr>
                                        ...
                                        <td id="contents" width="540" height="522" align="left" valign="top"><br>
                                            ...
                                            <form action="class_data.jsp" method="POST"class="form" onsubmit="return validAddClass();">

                                                <input type="text" name="class_id" placeholder="enter the  class id" size="50"/><br><p> </p>
                                                <input type="text" name="class_name" placeholder="enter the class name" size="50"/><br><p> </p>
