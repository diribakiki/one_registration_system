<%-- 
    Document   : admin
    Created on : Apr 11, 2024, 5:57:10 PM
    Author     : hp
--%>
                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            <left> <canvas  id="canvas" width="280" height="100"
                                   ...
                                   <div class="menu">
		<ul>
                    <h3> <a href="http://localhost:8080/Online%20school%20registration%20system/index.html">Homepage</a>&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="http://localhost:8080/Online%20school%20registration%20system/login/login.jsp">Log in page</a>&nbsp;&nbsp;&nbsp;&nbsp;
                         <a href="http://localhost:8080/Online%20school%20registration%20system/form/subject.jsp"> add Course</a>&nbsp;&nbsp;&nbsp;&nbsp;
                         <a href="http://localhost:8080/Online%20school%20registration%20system/form/batch.jsp"> add Batch</a>&nbsp;&nbsp;&nbsp;&nbsp;
                         <a href="http://localhost:8080/Online%20school%20registration%20system/form/class.jsp"> add Class</a>&nbsp;&nbsp;&nbsp;&nbsp;
                         <a href="http://localhost:8080/Online_Registration_Portal/Form1/Course.jsp"> add Semester</a>&nbsp;&nbsp;&nbsp;&nbsp;
                         <a href="http://localhost:8080/Online%20school%20registration%20system/form/session.jsp"> add Session</a>&nbsp;&nbsp;&nbsp;&nbsp;
                         <a href="http://localhost:8080/Online%20school%20registration%20system/form/subject.jsp"> add Subject</a>&nbsp;&nbsp;&nbsp;&nbsp;
                         <a href="http://localhost:8080/Online%20school%20registration%20system/form/users.jsp"> add User</a>&nbsp;&nbsp;&nbsp;&nbsp;
                         <a href="http://localhost:8080/Online%20school%20registration%20system/form/role.jsp"> add Role</a>&nbsp;&nbsp;&nbsp;&nbsp;
                         <a href="http://localhost:8080/Online%20school%20registration%20system/form/result.jsp">Student result page</a><h3>
                         <a href="http://localhost:8080/Online%20school%20registration%20system/form/notice.jsp"> Notice</a>&nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            <marquee behavior =alternate direction=right> <font size=3 color=blue> <b> <font size=5>W</font>elcome to the <font size=5>O</font>line<font size=5>R</font>egistration <font size=5>P</font>ortal </font></td>
                                    ...
                                    <tr>
                                        ...
                                        <td id="contents" width="540" height="522" align="left" valign="top"><br>
                                            ...
                                            <h1> Admin add form </h1><br/><p></p><br/>

                                            <form action="admin_data.jsp" method="POST"class="form" onsubmit="return validAddBatch();">

                                                <input type="text" name="admin_id" placeholder="enter the  admin id" size="50"/><br><p> </p>
                                                <input type="text" name="admin_name" placeholder="enter the admin name" size="50"/><br><p> </p>
                                                <input type="text" name="admin_email" placeholder="enter the admin email" size="50"/><br><p> </p>
                                                <input type="text" name="admin_phone" placeholder="enter the admin phone" size="50"/><br><p> </p>
