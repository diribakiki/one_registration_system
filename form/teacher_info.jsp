<%-- 
    Document   : teacher_info
    Created on : Apr 11, 2024, 12:20:28 PM
    Author     : hp
--%>
                            ...
                            <marquee behavior =alternate direction=right> <font size=3 color=blue> <b> <font size=5>W</font>elcome to the <font size=5>O</font>line<font size=5>R</font>egistration <font size=5>P</font>ortal </font></td>
                                    ...
                                    <tr>
                                        ...
                                        <td id="contents" width="540" height="522" align="left" valign="top"><br>
                                            ...
                                            <h1> Teacher information form </h1><br/><p></p><br/>

                                            <form action="teacher-info_data.jsp" method="POST"class="form" onsubmit="return validAddStudentinfo();">
                                                ...
                                                <input type="text" name="teacher-eamil" placeholder="enter the teacher email" size="50"/><br><p> </p>
                                                ...
                                                <input type="text" name="subj_id" placeholder="enter the date of subject id" size="50"/><br><p> </p>
