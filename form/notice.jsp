<%-- 
    Document   : notice
    Created on : Apr 11, 2024, 3:29:54 PM
    Author     : hp
--%>
                            ...
                            <marquee behavior =alternate direction=right> <font size=3 color=blue> <b> <font size=5>W</font>elcome to the <font size=5>O</font>line<font size=5>R</font>egistration <font size=5>P</font>ortal </font></td>
                                    ...
                                    <tr>
                                        ...
                                        <td id="contents" width="540" height="522" align="left" valign="top"><br>
                                            ...
                                            <h1> notice add form </h1><br/><p></p><br/>

                                            <form action="notice_data.jsp" method="POST"class="form" onsubmit="return validAddNotice();">

                                                <input type="text" name="notice_id" placeholder="enter the  notice id" size="50"/><br><p> </p>
                                                <input type="text" name="notice_title" placeholder="enter the notice title" size="250"/><br><p> </p>
                                                <input type="text" name="n_discription" placeholder="enter the notice discription" size="500"/><br><p> </p>
                                                <input type="text" name="publish_date" placeholder="enter the publish data" size="50"/><br><p> </p>
