<%-- 
    Document   : batch
    Created on : Apr 11, 2024, 5:41:12 PM
    Author     : hp
--%>
                            ...
                            <marquee behavior =alternate direction=right> <font size=3 color=blue> <b> <font size=5>W</font>elcome to the <font size=5>O</font>line<font size=5>R</font>egistration <font size=5>P</font>ortal </font></td>
                                    ...
                                    <tr>
                                        ...
                                        <td id="contents" width="540" height="522" align="left" valign="top"><br>
                                            ...
                                            <h1> Batch add form </h1><br/><p></p><br/>

                                            <form action="batch_data.jsp" method="POST"class="form" onsubmit="return validAddBatch();">

                                                <input type="text" name="batch_id" placeholder="enter the  batch id" size="50"/><br><p> </p>
                                                <input type="text" name="department_name" placeholder="enter the department name" size="50"/><br><p> </p>
                                                <input type="text" name="class_id" placeholder="enter the class id" size="50"/><br><p> </p>
                                                <input type="text" name="session_id" placeholder="enter the session id" size="50"/><br><p> </p>
