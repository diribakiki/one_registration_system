<%-- 
    ...
    Created on : Apr 2, 2024, 4:52:20 AM
    Author     : hp
--%>
                            ...
                            <marquee behavior =alternate direction=right> <font size=3 color=blue> <b> <font size=5>W</font>elcome to the <font size=5>O</font>line<font size=5>R</font>egistration <font size=5>P</font>ortal </font></td>
                                    ...
                                    <tr>
                                        ...
                                        <td id="contents" width="540" height="522" align="left" valign="top"><br>
                                            ...
                                            <h1>student attendance </h1><br/><p></p><br/>

                                            <div>
                                            <form action="student_attendance_data.jsp" method="POST"class="form" onsubmit="return validAddTeacher();">

                                                <input type="text" name="Student_att_id" placeholder="enter the  student attendance id" size="50"/><br><p> </p>
                                                <input type="text" name="student_att_data" placeholder="enter the student attendance date" size="50"/><br><p> </p>
                                                <input type="text" name="Student_id" placeholder="enter the student id" size="50"/><br><p> </p>
                                                <input type="text" name= "Status" placeholder="enter the status"size="50" /><br><p> </p>
