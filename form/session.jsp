<%-- 
    Document   : session
    Created on : Apr 11, 2024, 3:06:55 PM
    Author     : hp
--%>
                            ...
                            <marquee behavior =alternate direction=right> <font size=3 color=blue> <b> <font size=5>W</font>elcome to the <font size=5>O</font>line<font size=5>R</font>egistration <font size=5>P</font>ortal </font></td>
                                    ...
                                    <tr>
                                        ...
                                        <td id="contents" width="540" height="522" align="left" valign="top"><br>
                                            ...
                                            <h1> session add form </h1><br/><p></p><br/>

                                            <form action="session_data.jsp" method="POST"class="form" onsubmit="return validAddSession();">

                                                <input type="text" name="session_id" placeholder="enter the  session id" size="50"/><br><p> </p>
                                                <input type="text" name="session_year" placeholder="enter the session year" size="50"/><br><p> </p>
